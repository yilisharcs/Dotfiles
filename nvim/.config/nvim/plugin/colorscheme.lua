...
vim.api.nvim_set_hl(0, 'NormalNC', { bg = '#0f0f0f', fg = '#cdd6f4' })
...
vim.api.nvim_set_hl(0, 'TabLineFill', { link = 'ColorColumn' })
...
vim.api.nvim_set_hl(0, 'LspInlayHint', { fg = '#585858', bold = true })
