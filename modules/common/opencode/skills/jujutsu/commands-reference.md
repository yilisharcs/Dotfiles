...
| `jj diff --git` | Show changes in current commit (standard diff format) |
| `jj diff --git -r <rev>` | Show changes in specific revision |
| `jj diff --git --from <a> --to <b>` | Compare two revisions |
